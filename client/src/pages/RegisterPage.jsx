...
async function handleRegister(e) {
  ...
  try {
    ...
    // CASE A: backend auto-returns token
      ...
      <div className="auth-wrapper">
        <div className="auth-card">
          ...
          <p className="auth-subtext">
            Start practising, analysing and tracking your progress with IAPSS.
          </p>
          ...
          <div className="auth-social">
            <div className="auth-social-label">Or sign up with</div>
            <div className="auth-social-row">
              ...
              >
                <svg className="social-svg" viewBox="0 0 24 24" width="20" height="20" fill="#181717">
